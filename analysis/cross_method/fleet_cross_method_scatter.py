#!/usr/bin/env python3
"""Cross-method scatter plot: accuracy vs. cost for all fleet methods.

Each method gets a distinct color and marker. All experiments with valid
data are included — no manual exclusions.

Output:
    0_results/fleet_cross_method_scatter.png   — 3-panel accuracy vs cost
    0_results/fleet_cross_method_tradeoff.png  — computation vs communication

Usage:
    python -m analysis.cross_method.fleet_cross_method_scatter
"""
...
def plot_cross_method(all_records, output_path):
    ...
    fig.suptitle("Fleet Results — Accuracy vs. Cost by Method",
...
def plot_cross_method_tradeoff(all_records, output_path):
    ...
    ax.set_title("Fleet Results — Computation vs. Communication Tradeoff",
...
def main():
    ...
    plot_cross_method(all_records, "0_results/fleet_cross_method_scatter.png")
    plot_cross_method_tradeoff(all_records, "0_results/fleet_cross_method_tradeoff.png")
    return 0
