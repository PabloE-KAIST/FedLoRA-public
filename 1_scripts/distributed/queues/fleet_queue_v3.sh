#!/usr/bin/env bash
# Fleet: AdaSparse v3 — 3 rw × 3 gamma × 2 UL = 18 experiments per task. Same grid as v2.
#
# Accepts env vars:
...
CONFIG="2_yamls/adasparse_lora_v3/adasparse_lorav3_distributed.yaml"
QUEUE_LOG="${FEDLORA_ROOT}/exp_distributed/fleet_queue_v3.log"
...
EXP_OUTDIR="${FEDLORA_ROOT}/exp_distributed/adasparse_lorav3"
...
log "======== v3 queue complete (task=${TASK}): ${PASS} passed, ${FAIL} failed, ${SKIP} skipped ========"
